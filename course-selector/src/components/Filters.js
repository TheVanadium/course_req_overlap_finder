...
const badgeList = ["Scientific Method", "Literary and Textual Analysis", "Media and Visual Analysis", "Quantitative and Numerical Analysis", "Pratical and Applied Knowledge", "Ethics"];
